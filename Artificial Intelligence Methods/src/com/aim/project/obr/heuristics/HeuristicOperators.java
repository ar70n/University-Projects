...
public class HeuristicOperators {
    ...
    //My method
    protected int calculateObjectiveValue(SolutionRepresentationInterface oSolution) {

    	return this.m_oObjectiveFunction.getObjectiveFunctionValue(oSolution);
    }
    
    //My method
    protected void swap(int[]sol, int a, int b) {
		int tmp;		
		tmp = sol[a];
		sol[a] = sol[b];
		sol[b] = tmp;
