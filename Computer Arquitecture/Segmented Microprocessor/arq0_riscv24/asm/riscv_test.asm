##########################################################################
#   Programa de prueba para Practica 1 ARQO 2023 - rev 2024              #
##########################################################################
...
Pru_xor:    addi t4, zero, -1  # cargar x29 con FFF..FFF           
            ...
            xor  t5, t3, t4    # X30 -> t5 = not (t3), es decir 5555AAAA
            xor  t6, t5, t3    # X31 debe dar -1. t6 = t3 xor not(x3)
...
Load_use:   lw   t3, 12(t0)    # En x28 8d
            lw   t3, 16(t0)    # En x28 16d - 10h
            lw   t3, 20(t0)    # En x28 32d - 20h
            lw   t3,  0(t0)    # En x28 1d
            addi t4, t3, 1     # si load-use y FW X29=2
            addi t5, t3, 1     # si load-use y FW X30=2
            addi t6, t3, 1     # si load-use y FW X31=2
            nop
            nop
            nop 
...
Pru_AUIPC:  la   t0, buffer          # carga la dreccion del buffer en t0 (X5) (auiPC + addi). No funciona sin control de riesgos!
            ...
            j OK_prog                # si llega aqu� todas las pruebas OK
