/**
 * @brief It defines the test module, used by the different test that the project has
 *
 * @file test.h
 * @author Profesores PPROG
 * @version Unknown (the file had no information about this)
 * @date Unknown (the file had no information about this)
...
/*This macro prints the result of a test and stores if passed or not using static vars*/
