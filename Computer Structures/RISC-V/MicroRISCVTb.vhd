...
-- Fichero: MicroRISCVTb.vhd
-- Descripción: Banco de pruebas para el microprocesador RISC-V
...
entity MicroRISCVTb is
end MicroRISCVTb;
 
architecture Test OF MicroRISCVTb is
 
  -- Declaración del micro (sin memoria)
	component MicroRISCV
	port (
