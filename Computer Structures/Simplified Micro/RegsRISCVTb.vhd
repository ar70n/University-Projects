...
-- Fichero: RegsRISCVTb.vhd
-- Descripción: Testbench del banco completo de registros del microprocesador RISC-V
...
entity RegsRISCVTb is
end RegsRISCVTb;

architecture Practica of RegsRISCVTb is
