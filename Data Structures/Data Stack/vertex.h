...
/**
* @brief sets an index to the vertex
*
* @param vertex wich will be modified
* @param index to be set
*
* @return Staus, OK or ERROR if there is an error.
*/
Status vertex_set_index(Vertex* vertex, int index);
