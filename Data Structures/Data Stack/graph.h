...
/**
 * @brief gets the vertex from a given id
 * 
 *
 * @param g Pointer to the graph.
 * @param id of the vertex
 *
 * @return Return the respective Vertex from the given id or NULL if there is an error.
 **/
...
/*
 * @brief Gets all vertexs from the graph
 *
 * @param the graph
 *
 * @return the array of vretex or null if there is a problem
 */
